                ...
                if is_gameover:
                    ...
                    if now - self.last_report_monitor_time >= 60:
                        ...
                        if self.monitor:
                            ...
                            monitor_data["diy_12"] = round(metrics["rune_pickups"], 2)
                            ...
                            monitor_data["diy_16"] = round(metrics["monster_kills"], 2)
                            monitor_data["diy_27"] = round(metrics["base_returns"], 2)
                            monitor_data["diy_17"] = round(metrics["bad_fight_frames"], 2)
                            ...
                            monitor_data["diy_21"] = round(metrics["skill1_actions"], 2)
                            monitor_data["diy_22"] = round(metrics["skill2_actions"], 2)
                            monitor_data["diy_23"] = round(metrics["skill3_actions"], 2)
                            monitor_data["diy_24"] = round(metrics["skill_hit_frames"], 2)
                            monitor_data["diy_25"] = round(metrics["skill_hero_hit_frames"], 2)
                            monitor_data["diy_26"] = round(metrics["monster_hit_frames"], 2)
