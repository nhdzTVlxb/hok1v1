...
class Model(nn.Module):
    def __init__(self):
        ...
        self.feature_mlp = MLP([self.feature_dim, self.dim_public, self.lstm_unit_size], "feature_mlp", non_linearity_last=True)
        self.side_mlp = MLP([self.feature_dim, self.dim_public], "side_mlp", non_linearity_last=True)
    ...
    def forward(self, data_list, inference=False):
        ...
        side_embed = self.side_mlp(feature_vec)
