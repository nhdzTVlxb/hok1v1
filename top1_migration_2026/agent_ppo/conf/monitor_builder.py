...
def build_monitor():
    ...
    config_dict = (
        ...
        .add_panel(
            name="技能与野怪",
            name_en="skills_and_monsters",
            type="line",
        )
        .add_metric(metrics_name="diy_21", expr="round(avg(diy_21{}), 0.01)")
        .add_metric(metrics_name="diy_22", expr="round(avg(diy_22{}), 0.01)")
        .add_metric(metrics_name="diy_23", expr="round(avg(diy_23{}), 0.01)")
        .add_metric(metrics_name="diy_24", expr="round(avg(diy_24{}), 0.01)")
        .add_metric(metrics_name="diy_25", expr="round(avg(diy_25{}), 0.01)")
        .add_metric(metrics_name="diy_26", expr="round(avg(diy_26{}), 0.01)")
        .end_panel()
        .end_group()
        .build()
    )
